...
**Cause**: Recent Ollama versions appear to validate inbound `Authorization` headers if they're present and reject mismatched ones. Caddy was forwarding the (now-validated) bearer head